# Remnawave + MWScdn: WebSocket + SNI Spoofing1

Это руководство описывает настройку отказоустойчивой архитектуры для VPN-ноды на базе **Xray (Remnawave)** с использованием протокола **WebSocket** и маскировкой трафика через CDN (MWScdn).
